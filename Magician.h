...
struct Magician : Enemy {
    ...
    float walkAnimationSpeed = 1.f / 5.f;
    float attackSpeed = 1.f/15.f;
    float deadSpeed = 1.f/10.f;
    float hitSpeed = 1.f/3.f;
    ...
    //logic detecting
    float detectingRange = 1100.f;
    float attackCooldown = 2.0f;
    float lastAttackTime = attackCooldown;

    //constructor
    Magician(const sf::Vector2u& windowSize, float x = 900.f, float y = 440.f);
