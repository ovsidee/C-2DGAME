...
struct NightBorn : Enemy {
    ...
    //speed of animations
    float animationSpeed = 1.f / 9.f;
    float walkAnimationSpeed = 1.f / 6.f;
    float attackSpeed = 1.f/20.f;
    float deadSpeed = 1.f/21.f;
    float hitSpeed = 1.f/5.f;
    ...
    // stats
    int hp = 50;
    int damageOfAttack = 20;

    //speed of actions
    float speedOfWalk = 20.f;

    //logic detecting
    float detectingRange = 1030.f;
    float attackCooldown = 2.0f;
    float lastAttackTime = attackCooldown;


    //constructor
    NightBorn(const sf::Vector2u& windowSize, float x = 900.f, float y = 440.f);
